  ...
  return (
    <div>
      ...
      <p>
        ...
        <b>Cooling Centers</b>: Cooled indoor locations that provide refuge from
        the heat during the day. Drinking fountains or bottled water is
        available.
      </p>

      <p>
        <img src={hydrationLogo} alt="hydration" />
        <b>Hydration Stations</b>: Locations where individuals can go to receive
        bottled water and other collected donated items. Can be indoors or
        outdoors.
      </p>
      ...
      <p>
        ...
        hydration and cooling locations. Some sites also accept other donations,
        such as cash; light colored, long-sleeved tee-shirts; socks; underwear;
        hats; lip balm; sun block; and pre-packaged snacks.
      </p>
      ...
      >
        <a
          ...
          href="https://azmag.gov/Programs/Heat-Relief-Network"
          target="_blank"
          rel="noreferrer"
        >
          The Heat Relief Network
        </a>{' '}
        is a regional partnership of the Maricopa Association of Governments
        (MAG), municipalities, nonprofit organizations, the faith-based
        community, and businesses. Each year, MAG coordinates the mapping of the
        Heat Relief Network, a network of partners providing cooling centers,
        hydration stations, and water donation sites throughout the Valley with
        the goal of preventing heat-related illnesses and deaths among
